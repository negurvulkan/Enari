<section class="entity-template entity-template--default">
    <header class="entity-template__header"{if $entryView.type.color ne ''} style="--entity-accent: {$entryView.type.color|escape:'htmlattr'};"{/if}>
        <div class="entity-template__title-block">
            <p class="entity-template__eyebrow">{$entryView.type.label|default:'Entity'}</p>
    ...
    {if $entryView.groups}
        <div class="entity-template__grid">
                            ...
                            <div class="entity-fields__row entity-fields__row--{$field.type|escape:'htmlattr'}">
                                ...
                                <dd>
                                    ...
                                    {if $field.description ne ''}
                                        <span class="entity-fields__hint">{$field.description}</span>
                                    {/if}
                                </dd>
                            </div>
                        {/foreach}
    ...
    {if $contentHtml ne ''}
        <div class="entity-template__body markdown-body">
